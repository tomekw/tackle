...
package body Tackle_Suite is
   ...
   Tackle_Codepoint_Iterators : aliased Tackle_Codepoint_Iterators_Tests.Test_Case;
   ...
   begin
      ...
      AUnit.Test_Suites.Add_Test (Result'Access, Tackle_Codepoint_Iterators'Access);
