...
package body Tackle_Targets_Tests is
   ...
   procedure Test_Target_Info (T : in out Test_Context) is
      ...
      use type Targets.Libc_Kind;

      Actual : constant Targets.Target := Targets.Init;
      Valid_Libc : constant Boolean := (Actual.Libc = Targets.Musl or Actual.Libc = Targets.Other);
   begin
      ...
      T.Expect (Valid_Libc, "Expected Libc'Image either musl or other");
